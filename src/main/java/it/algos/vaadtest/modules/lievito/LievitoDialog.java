 ...
 * Costruita (nella List) con appContext.getBean(LievitoDialog.class, service, entityClazz);
 * <p>
...
public class LievitoDialog extends AViewDialog<Lievito> {
     ...
     * L'istanza DEVE essere creata con appContext.getBean(LievitoDialog.class, service, entityClazz); <br>
     *
     * @param service     business class e layer di collegamento per la Repository
     * @param binderClass di tipo AEntity usata dal Binder dei Fields
     */
    public LievitoDialog(IAService service, Class<? extends AEntity> binderClass) {
