...
public class SecoloList extends ACronoViewList {
     ...
     */
    @Autowired
    public SecoloList(@Qualifier(TAG_SEC) IAService service) {
        super(service, Secolo.class);
    ...
    protected void openDialog(AEntity entityBean) {
        SecoloDialog dialog = appContext.getBean(SecoloDialog.class, service, entityClazz);
