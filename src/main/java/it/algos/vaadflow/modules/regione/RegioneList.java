...
public class RegioneList extends AGridViewList {
    ...
    protected void openDialog(AEntity entityBean) {
        appContext.getBean(RegioneDialog.class, service, entityClazz).open(entityBean, isEntityModificabile ? EAOperation.edit : EAOperation.showOnly, this::save, this::delete);
    }// end of method
